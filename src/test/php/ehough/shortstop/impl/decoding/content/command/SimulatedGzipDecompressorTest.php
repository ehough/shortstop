 ...
 */
class ehough_shortstop_impl_decoding_content_command_SimulatedGzipDecompressorTest extends ehough_shortstop_impl_decoding_content_command_AbstractContentDecompressingCommandTest
{
    protected function buildSut()
    {
        return new ehough_shortstop_impl_decoding_content_command_SimulatedGzipDecompressingCommand();
    }
