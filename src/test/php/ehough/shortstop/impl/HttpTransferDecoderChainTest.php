...
class ehough_shortstop_impl_HttpTransferDecoderChainTest extends ehough_shortstop_impl_AbstractDecoderChainTest
{
    protected function buildSut(ehough_chaingang_api_Chain $chain)
    {
        return new ehough_shortstop_impl_HttpTransferDecoderChain($chain);
    }
