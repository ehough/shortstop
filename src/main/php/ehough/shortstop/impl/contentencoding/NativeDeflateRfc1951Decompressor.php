 ...
 */
class ehough_shortstop_impl_contentencoding_NativeDeflateRfc1951Decompressor extends ehough_shortstop_impl_contentencoding_AbstractDecompressorCommand
{
    private $_logger;
    ...
    protected function getLogger()
    {
        if (! isset($this->_logger)) {
            ...
            $this->_logger = ehough_epilog_api_LoggerFactory::getLogger('gzinflate Decompressor');
        }
